...
- Inter Variable 4.66: upstream `rsms/inter`, SIL Open Font License 1.1.
- Smiley Sans 2.0.1: upstream `atelier-anchor/smiley-sans`, SIL Open Font License 1.1.
- HarmonyOS Sans SC: upstream Huawei, HarmonyOS Font License Agreement.
- Sarasa Gothic SC: upstream `be5invis/Sarasa-Gothic`, SIL Open Font License 1.1.

The release TTF files were converted to WOFF2 without removing characters.
License texts are retained under `licenses/`.
