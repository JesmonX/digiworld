...
function buildPreset(id: ThemeId, schemeId: ColorSchemeId = DEFAULT_COLOR_SCHEME_ID): ThemePreset {
  ...
  return {
    ...
    colors: {
      ...
      'shadow-xs': scheme === 'light' ? '0 1px 2px rgba(30, 35, 55, .025)' : '0 1px 2px rgba(0, 0, 0, .12)',
      'shadow-sm': scheme === 'light' ? '0 6px 18px rgba(30, 35, 55, .045)' : '0 6px 18px rgba(0, 0, 0, .14)',
      'shadow-md': scheme === 'light' ? '0 12px 30px rgba(30, 35, 55, .060)' : '0 12px 30px rgba(0, 0, 0, .18)',
      'shadow-lg': scheme === 'light' ? '0 20px 48px rgba(30, 35, 55, .085)' : '0 20px 48px rgba(0, 0, 0, .24)',
    },
  }
}
