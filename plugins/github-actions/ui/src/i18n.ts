...
export const DICTIONARY = {
  ...
  connectSubtitle: { en: 'Personal access token is stored securely in system keychain. Requires repo Actions read permission.', zh: '访问令牌只保存在系统凭据库，需要仓库工作流的只读权限。' },
  tokenAria: { en: 'GitHub Token', zh: 'GitHub 访问令牌' },
  connectButton: { en: 'Connect Account', zh: '连接账号' },
  connecting: { en: 'Connecting...', zh: '连接中…' },
  toolbarTitle: { en: "{login}'s Actions", zh: '{login} 的工作流' },
  ...
  searchPlaceholder: { en: 'Search owner/repo', zh: '搜索所有者/仓库' },
  ...
  showJobs: { en: 'Show jobs and steps', zh: '展开作业与步骤' },
  hideJobs: { en: 'Hide jobs and steps', zh: '收起作业与步骤' },
  loadingJobs: { en: 'Loading job details...', zh: '正在加载 作业 详情…' },
  jobsLoadFailed: { en: 'Job details unavailable: {error}', zh: '作业 详情加载失败：{error}' },
  noJobs: { en: 'No jobs returned for this run', zh: '该运行没有返回 作业' },
  noSteps: { en: 'No steps returned for this job', zh: '该 作业 没有返回步骤' },
  jobLink: { en: 'Open job', zh: '打开 作业' },
} as const
