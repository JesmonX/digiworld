...
pub struct Account {
    ...
    pub body_total: u64,
    pub body_completed: u64,
    pub body_attempted: u64,
    pub body_failed: u64,
    pub body_pending: u64,
    pub body_retry_count: u64,
    pub body_next_retry_at: Option<String>,
    pub body_last_error_category: Option<String>,
